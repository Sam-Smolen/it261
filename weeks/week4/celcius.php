...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(isset($_POST['cel'])) {
        $cel = $_POST['cel'];
        // we will use a new function to make sure that are values are integers using intval()
        $cel_int = intval($cel);
        $far = ($cel_int *9/5) + 32;

        // if the end user does not enter a vlue, say something
        ...
        echo '<p> '.$cel_int.' degrees equals '.$far.' degrees farenheit <br>
